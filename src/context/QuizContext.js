...
function Provider({ children }) {
  ...
  const questions = {
    A1: [
      {
        id: 1,
        question: "নির্দিষ্ট কিছু বিষয়ের ওপর বিশ্বাস স্থাপন করা এবং সেই বিশ্বাসের পরিপালন করাকে ইসলামী পরিভাষায় কী বলে?",
        answers: [
          { answer: "আকীদা", trueAnswer: true },
          { answer: "তাওহীদ", trueAnswer: false },
          { answer: "ফিকহ", trueAnswer: false },
          { answer: "মু'আমালাত", trueAnswer: false },
        ],
      },
      {
        id: 2,
        question: "আয়াতুল কুরসী সূরা আল-বাকারার কত নং আয়াত?",
        answers: [
          { answer: "১৫০", trueAnswer: false },
          { answer: "১৫৫", trueAnswer: false },
          { answer: "২৫০", trueAnswer: true },
          { answer: "২৫৫", trueAnswer: false },
        ],
      },
      {
        id: 3,
        question: "সূরা বাকারা’-এর আয়াত সংখ্যা কত?",
        answers: [
          { answer: "২৭৬টি", trueAnswer: false },
          { answer: "২৮৬টি", trueAnswer: true },
          { answer: "২৬৬টি", trueAnswer: false },
          { answer: "২৫৬টি", trueAnswer: false },
        ],
      },
      {
        id: 4,
        question: "আলিফ লাম মীম দ্বারা শুরু হওয়া সূরা কতটি?",
        answers: [
          { answer: "৬টি", trueAnswer: true },
          { answer: "৮টি", trueAnswer: false },
          { answer: "১০টি", trueAnswer: false },
          { answer: "১২টি", trueAnswer: false },
        ],
      },
      {
        id: 5,
        question: "কোন সূরাটি রসূলুল্লাহ (সাঃ) প্রতি জুমাবার খুতবায় পড়তেন?",
        answers: [
          { answer: "সূরা ক্বাফ", trueAnswer: true },
          { answer: "সূরা বাকারা", trueAnswer: false },
          { answer: "সূরা কাহ্ফ", trueAnswer: false },
          { answer: "সূরা নূর", trueAnswer: false },
        ],
      },
      {
        id: 6,
        question: "কোন সূরায় বিসমিল্লাহ্ নেই?",
        answers: [
          { answer: "সূরা কাহ্ফ", trueAnswer: false },
          { answer: "সূরা তাওবায়", trueAnswer: true },
          { answer: "সূরা বাকারা", trueAnswer: false },
          { answer: "সূরা ক্বাফ", trueAnswer: true },
        ],
      },
      {
        id: 7,
        question: "নবীদের মধ্যে কোন নবী দুনিয়াতে আল্লাহকে দেখতে চেয়েছেন?",
        answers: [
          { answer: "মোহাম্মাদ(সাঃ) ", trueAnswer: false },
          { answer: "আদম (আ.)", trueAnswer: false },
          { answer: "মূসা (আ.)", trueAnswer: true },
          { answer: "ইব্রাহিম (আ.)", trueAnswer: false },
        ],
      },
      {
        id: 8,
        question: "সর্বপ্রথম আল কুরআনের পূর্ণাঙ্গ কোন সূরা নাযিল হয়?",
        answers: [
          { answer: "সূরা আল মায়িদা", trueAnswer: false },
          { answer: "সূরা তাওবায়", trueAnswer: false },
          { answer: "সূরা ফাতিহা", trueAnswer: true },
          { answer: "সূরা রাদ’", trueAnswer: false },
        ],
      },
      {
        id: 9,
        question: "সূরা বনী ইসরাঈল’-এর অর্থ কী?",
        answers: [
          { answer: "নবীগণ", trueAnswer: false },
          { answer: "গৃহপালিত পশু", trueAnswer: false },
          { answer: "গুহা", trueAnswer: false },
          { answer: "ইসরাঈলের বংশধর", trueAnswer: true },
        ],
      },
      {
        id: 10,
        question: "সূরা আল হাজ্জ’-এর অর্থ কী?",
        answers: [
          { answer: "সমাবেশ", trueAnswer: false },
          { answer: "পরম করুণাময়", trueAnswer: false },
          { answer: " ইচ্ছা করা", trueAnswer: true },
          { answer: "আলাে", trueAnswer: false },
        ],
      },
    ...
    A2: [
      {
        id: 1,
        question: "প্রথম রসূলের নামে কোন সূরার নামকরণ করা হয়েছে?",
        answers: [
          { answer: "সূরা নূহ", trueAnswer: true },
          { answer: "সূরা ইউসুফ", trueAnswer: false },
          { answer: "সূরা ইউনুস", trueAnswer: false },
          { answer: "সূরা ইব্ররাহিম", trueAnswer: false },
        ],
      },
      {
        id: 2,
        question: "কোন সূরাকে কুরআনের মুকুট বলা হয়েছে?",
        answers: [
          { answer: "সূরা ফাতিহাকে", trueAnswer: false },
          { answer: "সূরা বাকারাকে", trueAnswer: false },
          { answer: "সূরা আর রাহমানকে", trueAnswer: true },
          { answer: "সূরা ইখলাসকে ", trueAnswer: false },
        ],
      },
      {
        id: 3,
